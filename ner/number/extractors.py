...
from recognizers_number import AgnosticNumberParserFactory, ParserType, ChineseNumberParserConfiguration
...
class ZHCustomizedExtractor(BaseNumberExtractor):
    @property
    def regexes(self) -> List[ReVal]:
        return self.__regexes
...
class DatetimeIntegerExtractor(BaseNumberExtractor):
    @property
    def regexes(self) -> List[ReVal]:
        return self.__regexes
    ...
    def __init__(self, mode: ChineseNumberExtractorMode = ChineseNumberExtractorMode.DEFAULT):
        ...
        if mode == ChineseNumberExtractorMode.DEFAULT:
            ...
            self.__regexes.append(
                ReVal(
                    re=RegExpUtility.get_safe_reg_exp(
                        CustomNumeric.MinuteRegex),
                    val='IntegerChs'
                )
            )
            self.__regexes.append(
                ReVal(
                    re=RegExpUtility.get_safe_reg_exp(CustomNumeric.WeekNum),
                    val='IntegerChs'
                )
            )
        elif mode == ChineseNumberExtractorMode.EXTRACT_ALL:
